        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-slate-600">
              ...
              kesehatan keuanganmu — semua dalam satu dashboard yang simpel dan bisa dicustom.
            </p>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600">Score: <b>78 / 100</b></span>
                    <span className="font-medium text-blue-600">+5.2% from last month</span>
                  </div>
                </div>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-32">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-900">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> Master Your Finances</span>
          </h2>
...
function ModernFeature({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-lg shadow-blue-500/5 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-2">
      ...
      <div className={`mb-6 inline-flex rounded-xl bg-gradient-to-br ${gradient} p-3 text-white`}>
        {icon}
      </div>
